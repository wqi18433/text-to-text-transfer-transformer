...
We trained a second set of models which seem to have better quality.  The differences from the models described above are as follows:
...
* t5.1.1.* versions: same number of layers and approximately same parameter counts as the originals.  "xl" and "xxl" replace "3B" and "11B".  The model shapes are a bit different - larger d_model and smaller num_heads and d_ff.
